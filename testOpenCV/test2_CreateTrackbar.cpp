...
void on_Trackbar(int, void*)
{
    ...
    g_dAlphaValue = 1.0 * getTrackbarPos(TRACKBARNAME, WINDOW_NAME) / g_nMaxAlphaValue;

    //则beta值为1减去alpha值
    g_dBetaValue = (1.0 - g_dAlphaValue);

    //根据alpha和beta值进行线性混合, 注意g_srcImage1 和 g_srcImage2 长宽要相同
